    ...
    public partial class valuechange : Form
    {
        ...
        private void List_selection2()
        {
            ...
            if (index >= 0)
            {
                ...
                textBox11.Text = listBox3.Items[index].ToString();
            }
        }
        ...
        private void valuechange_FormClosing(object sender, FormClosingEventArgs e)
        {
            Hide();
            e.Cancel = true;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           for ( int i = 0; i < listBox2.Items.Count; i++)
           {
                ...
                string src = "";
                src += form1.comboBox2.Text + "$'" + comboBox1.Text + "'[";
                ...
                try
                {
                    ...
                    if (sr.EndOfStream == false)
                    {
                        ...
                        for (int i = 0; i < num; i++)
                        {
                            ...
                            line = sr.ReadLine();
                            listBox3.Items.Add(line.Replace("\r\n", ""));
                        }
                    }
                    line = sr.ReadLine();
                    line = line.Replace("\r\n", "");
        ...
        {
            string n = "";
            if (checkBox1.Checked) n = "!";
            if (trackBar1.Value > 0 && trackBar2.Value < 10)
            {
                listBox2.Items.Add(n + "(" + textBox4.Text + " >= " + textBox9.Text + ") & (" + textBox4.Text + " <= " + textBox10.Text + ")");
                listBox3.Items.Add("");
            }
            if (trackBar1.Value > 0 && trackBar2.Value == 10)
            {
                listBox2.Items.Add(n + "(" + textBox4.Text + " >= " + textBox9.Text + ")");
                listBox3.Items.Add("0");
            }
            if (trackBar1.Value == 0 && trackBar2.Value < 10)
            {
                listBox2.Items.Add(n + "(" + textBox4.Text + " <= " + textBox10.Text + ")");
                listBox3.Items.Add("0");
            }
            if (trackBar1.Value == 0 && trackBar2.Value == 10)
            {
            ...
            textBox2.Text = listBox2.Items[listBox2.Items.Count-1].ToString();
            textBox11.Text = listBox3.Items[listBox3.Items.Count - 1].ToString();
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (index >= 0)
            {
                ...
                listBox3.Items[index] = textBox11.Text;
            }
        }
