...
namespace WindowsFormsApplication1
{
    public partial class sort : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ソートの第1のキーを選択して下さい");
                return;
            }
            var t = DateTime.Now;
            ...
            //cmd += form1.comboBox3.Text + "<- c(1:nrow(" + form1.comboBox2.Text + "))\r\n";
            cmd += "sort_tmp <- order(";
            cmd += "df$'" + listBox1.Items[listBox1.SelectedIndex].ToString()+"'";
            ...
            if (listBox2.SelectedIndices.Count > 0)
            {
                ...
                {
                    cmd += "df$'" + listBox2.SelectedItems[i].ToString()+"'";
            ...
            cmd += ")\r\n";
            cmd += form1.comboBox2.Text + "<- df[sort_tmp,]\r\n";
            if ( checkBox1.Checked)
            {
                cmd += "rownames(" + form1.comboBox2.Text + ") <- c(1:nrow(" + form1.comboBox2.Text + "))\r\n";
            }
            textBox5.Text = cmd;
        }
        ...
        private void trackBar1_sortd(object sender, EventArgs e)
        {
        }

        private void trackBar2_sortd(object sender, EventArgs e)
        {
        }
