...
namespace WindowsFormsApplication1
{
    public partial class aggregate : Form
    {
        ...
        private void Hist(string text)
        {
            ...
            try
            {
                using (System.IO.StreamWriter sw = new System.IO.StreamWriter(file, false, System.Text.Encoding.GetEncoding("shift_jis")))
                {
                    ...
                    sw.Write("if ( (is.numeric(" + text + ") || is.integer(" + text + "[!is.na(" + text + ")]))){\r\n");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd += "aggregate_tmp <- df";

            }
            else
            {
                cmd += "aggregate_tmp <- df[, c(";
            ...
            string fun = "sum";
            if (comboBox1.Text == "合計") fun = "sum";
            else if (comboBox1.Text == "平均") fun = "mean";
            else if (comboBox1.Text == "最小") fun = "min";
            else if (comboBox1.Text == "最大") fun = "max";
            else if (comboBox1.Text == "個数") fun = "length";
            cmd += form1.comboBox2.Text + "<- aggregate(aggregate_tmp, by=group_tmp, FUN=" + fun + ")\r\n";
            textBox5.Text = cmd;
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                form1.textBox1.Text = form1.comboBox2.Text + "<-df\r\n";
        ...
        private void trackBar1_aggregated(object sender, EventArgs e)
        {
        }

        private void trackBar2_aggregated(object sender, EventArgs e)
        {
        }
